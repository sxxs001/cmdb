# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2016-12-05 17:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conf_sn', models.CharField(choices=[('1', 'py9'), ('2', 'py5'), ('3', 'py0_2'), ('4', 'py2'), ('5', 'vm1'), ('6', 'py1'), ('7', 'py0'), ('8', 'py0_3'), ('9', 'py3'), ('10', 'py4'), ('11', 'adb2'), ('12', 'tvm0'), ('13', 'avm11'), ('14', 'avm13'), ('15', 'vm3'), ('16', 'avm2'), ('17', 'py11'), ('18', 'adb1')], help_text='\u5fc5\u987b\u552f\u4e00&\u4e0d\u80fd\u4e3a\u7a7a', max_length=300, verbose_name='\u673a\u578b\u7f16\u53f7')),
                ...
                ('brand_model', models.ManyToManyField(related_name='model', to='cmdb.BrandModel', verbose_name='\u54c1\u724c/\u578b\u53f7')),
            ],
            options={
